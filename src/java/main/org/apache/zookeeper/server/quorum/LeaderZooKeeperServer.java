...
import org.apache.zookeeper.server.RequestProcessorChainForLeader;
...
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    ...
    protected void setupRequestProcessors() {
    	RequestProcessorChainForLeader chain = createChain();
    	commitProcessor = chain.getCommitProcessor();
    	defaultChain = chain.start();
    }
    
    @Override
    protected RequestProcessorChainForLeader createChain() {
		return RequestProcessorChain.forLeader(this);
	}
